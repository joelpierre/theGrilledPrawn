...
"use strict";
eval("\n\nvar _recipes = __webpack_require__(/*! ./recipes.service */ \"./assets/js/recipes.service.js\");\n\nvar recipesService = _interopRequireWildcard(_recipes);\n\nvar _newsletter = __webpack_require__(/*! ./newsletter.service */ \"./assets/js/newsletter.service.js\");\n\nvar newsletterService = _interopRequireWildcard(_newsletter);\n\nvar _toggles = __webpack_require__(/*! ./toggles.service */ \"./assets/js/toggles.service.js\");\n\nvar togglesService = _interopRequireWildcard(_toggles);\n\nfunction _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }\n\nvar navToggle = document.querySelector('#js-navbar-toggle');\nvar filterToggle = document.querySelector('#js-filter-toggle');\nvar searchToggle = document.querySelector('#js-search-toggle');\nvar singupForm = document.querySelector('#js-newsletter-signup-form');\n\nvar userSignupRows = document.querySelectorAll('.signup-user-row');\n\nvar signupRowContainer = document.querySelector('#js-signup-row-container');\nvar recipeContainer = document.querySelector('#js-recipe-container');\nvar recipes = recipesService.getRecipes();\n\nvar signupRowCount = userSignupRows.length;\n\n(function () {\n  // Pull through recipes on load\n  var _iteratorNormalCompletion = true;\n  var _didIteratorError = false;\n  var _iteratorError = undefined;\n\n  try {\n    for (var _iterator = recipes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {\n      var recipe = _step.value;\n\n      recipeContainer.insertAdjacentHTML('beforeend', recipesService.recipeCard(recipe));\n    }\n  } catch (err) {\n    _didIteratorError = true;\n    _iteratorError = err;\n  } finally {\n    try {\n      if (!_iteratorNormalCompletion && _iterator.return) {\n        _iterator.return();\n      }\n    } finally {\n      if (_didIteratorError) {\n        throw _iteratorError;\n      }\n    }\n  }\n})();\n\n// Navbar Toggle Click\nnavToggle.addEventListener('click', function () {\n  return togglesService.toggleMobileNav();\n});\n\n// Filter Toggle Click\nfilterToggle.addEventListener('click', function () {\n  return togglesService.toggleFilterOptions();\n});\n\n// Search Toggle Click\nsearchToggle.addEventListener('click', function () {\n  return togglesService.toggleSearchBar();\n});\n\n// Form Submit\nsingupForm.addEventListener('submit', function (event) {\n  event.preventDefault();\n  event.stopPropagation();\n  return alert('Here we need to validate the inputted data and submit the form values to an external API etc.');\n});\n\n// Add Newsletter rows\nsignupRowContainer.addEventListener('click', function (event) {\n  event.preventDefault();\n  event.stopPropagation();\n\n  var elm = event.target;\n\n  if (event.target.matches('.btn-delete-user-row')) {\n    var rowContainer = elm.closest('.signup-user-row');\n    rowContainer.parentNode.removeChild(rowContainer);\n  }\n\n  if (event.target.matches('.btn-add-user-row')) {\n    signupRowCount++;\n\n    newsletterService.addRemoveBtn(elm);\n\n    signupRowContainer.insertAdjacentHTML('beforeend', newsletterService.newSignupRow(signupRowCount));\n  }\n});\n\n//# sourceURL=webpack:///./assets/js/main.js?");

/***/ }),

/***/ "./assets/js/newsletter.service.js":
/*!*****************************************!*\
  !*** ./assets/js/newsletter.service.js ***!
  \*****************************************/
/*! no static exports found */
